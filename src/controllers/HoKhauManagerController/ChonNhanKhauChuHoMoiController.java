...
public class ChonNhanKhauChuHoMoiController {

    private List<ThanhVienCuaHoModel> listThanhVienCuaHo;
    private JTable tableJpn;
    private NhanKhauService nhanKhauService;

    public ChonNhanKhauChuHoMoiController(JTable tableJpn, List<ThanhVienCuaHoModel> listThanhVienCuaHo) {
    ...
    public NhanKhauModel GetPickedNhanKhauModel() {
        ...
        for (int row = 0; row < model.getRowCount(); row++) {
            ...
            if (model.getValueAt(row, 0) == obj) {
                nhanKhauModel = GetNhanKhau(listThanhVienCuaHo.get(row).getSoCCCD());
            }
        }

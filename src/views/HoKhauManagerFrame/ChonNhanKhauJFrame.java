...
public class ChonNhanKhauJFrame extends javax.swing.JFrame {
    ...
    /**
     * Creates new form ChonNhanKhauJFrame
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChonNhanKhauJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChonNhanKhauJFrame().setVisible(true);
            }
        });
    }

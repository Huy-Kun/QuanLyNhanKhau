...
import controllers.HoKhauManagerController.ChonThanhVienHoKhauMoiController;
...
public class ChonThanhVienHoKhauMoiJFrame extends javax.swing.JFrame {

    private JFrame parentJframe;
    private ChonThanhVienHoKhauMoiController controller;
    private TachHoKhauController parentController;
    private List <NhanKhauModel> listThanhVien;
    
    public ChonThanhVienHoKhauMoiJFrame(JFrame parentJframe, TachHoKhauController parentController, List <NhanKhauModel> listThanhVien) {
        initComponents();
        this.parentJframe = parentJframe;
        this.parentJframe.setEnabled(false);
        this.listThanhVien = listThanhVien;
        this.parentController = parentController;
        this.controller = new ChonThanhVienHoKhauMoiController(jTable3, parentController.GetListThanhVienTach());
        InitAction();
    ...
    private void btnTiepTucActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTiepTucActionPerformed
        ...
        this.controller.GetPickedNhanKhauModel().forEach(nhanKhauModel -> {

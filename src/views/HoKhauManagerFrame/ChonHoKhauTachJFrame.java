...
import controllers.HoKhauManagerController.ChonHoKhauTachController;
...
public class ChonHoKhauTachJFrame extends javax.swing.JFrame {

    private JFrame parentJframe;
    private TachHoKhauController parentController;
    private ChonHoKhauTachController controller;
    private List<HoKhauModel> list;
    private HoKhauModel hoKhauModel;

    public ChonHoKhauTachJFrame(JFrame parentJframe, TachHoKhauController parentController, HoKhauModel hoKhauModel) {
        initComponents();
        this.parentJframe = parentJframe;
        this.parentJframe.setEnabled(false);
        this.parentController = parentController;
        this.hoKhauModel = hoKhauModel;
        this.controller = new ChonHoKhauTachController(jTable3, parentController.GetListHoKhau());
        InitAction();
